...
public class DeterminacionesAHacer extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeterminacionesAHacer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DeterminacionesAHacer dialog = new DeterminacionesAHacer(new javax.swing.JFrame(), true, "", -1, false);
