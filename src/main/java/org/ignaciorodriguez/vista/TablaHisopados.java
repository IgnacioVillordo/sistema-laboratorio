...
public class TablaHisopados extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        comboColiformesIn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                comboColiformesInActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        cajaSalmonella.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cajaSalmonellaActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        comboVibrioIn.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                comboVibrioInItemStateChanged(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
...
//            comboGermenesIn.setVisible(true);
    ...
    private void checkColiformesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkColiformesActionPerformed
        if (checkColiformes.isSelected()) {
...
//            comboColiformesIn.setVisible(true);
    ...
    }//GEN-LAST:event_checkColiformesActionPerformed
    ...
    private void etiquetaEnterobacteriasMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_etiquetaEnterobacteriasMousePressed
    ...
    }//GEN-LAST:event_etiquetaEnterobacteriasMousePressed
    ...
    private void etiquetaListeriaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_etiquetaListeriaMousePressed
    ...
    }//GEN-LAST:event_etiquetaListeriaMousePressed

    private void cajaSalmonellaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cajaSalmonellaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cajaSalmonellaActionPerformed

    private void comboColiformesInActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboColiformesInActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_comboColiformesInActionPerformed
    ...
    private void comboListeriaInItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_comboListeriaInItemStateChanged
...
//        }
//        jPanel20.updateUI();
    }//GEN-LAST:event_comboListeriaInItemStateChanged

    private void etiquetaVibrioMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_etiquetaVibrioMousePressed
    ...
    }//GEN-LAST:event_etiquetaVibrioMousePressed

    private void comboVibrioInItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_comboVibrioInItemStateChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_comboVibrioInItemStateChanged
