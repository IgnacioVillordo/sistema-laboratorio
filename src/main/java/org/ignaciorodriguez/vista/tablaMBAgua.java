...
public class tablaMBAgua extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        comboMohos.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                comboMohosItemStateChanged(evt);
            }
        });
        comboMohos.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                comboMohosActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        campoMohos.addCaretListener(new javax.swing.event.CaretListener() {
            public void caretUpdate(javax.swing.event.CaretEvent evt) {
                campoMohosCaretUpdate(evt);
            }
        });
        campoMohos.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                campoMohosActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        checkLimiteMohos.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                checkLimiteMohosActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
    ...
    private void comboMohosItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_comboMohosItemStateChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_comboMohosItemStateChanged

    private void comboMohosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboMohosActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_comboMohosActionPerformed

    private void campoMohosCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_campoMohosCaretUpdate
        // TODO add your handling code here:
    }//GEN-LAST:event_campoMohosCaretUpdate

    private void campoMohosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_campoMohosActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_campoMohosActionPerformed

    private void checkLimiteMohosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkLimiteMohosActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_checkLimiteMohosActionPerformed
