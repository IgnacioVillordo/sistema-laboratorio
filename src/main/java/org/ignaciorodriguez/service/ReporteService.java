...
import main.java.org.ignaciorodriguez.vista.VentanaEmail;
...
public class ReporteService {
    ...
    public void generarReporte(String archivoJasper, int id, String prefijoNombre, String procedencia){
        try {
            ...
            if (nombre[0].contains("/") || nombre[0].contains("" + main.java.org.ignaciorodriguez.utils.SeparatorUtils.s + "") || nombre[0].contains(":") || nombre[0].contains("*") || nombre[0].contains("?") || nombre[0].contains("\"") || nombre[0].contains("<") || nombre[0].contains(">") || nombre[0].contains(">") || nombre[1].contains("/") || nombre[1].contains("" + main.java.org.ignaciorodriguez.utils.SeparatorUtils.s + "") || nombre[1].contains(":") || nombre[1].contains("*") || nombre[1].contains("?") || nombre[1].contains("\"") || nombre[1].contains("<") || nombre[1].contains(">") || nombre[1].contains(">")) {
                nombre[0] = nombre[0].replaceAll("[/" + main.java.org.ignaciorodriguez.utils.SeparatorUtils.s + "" + main.java.org.ignaciorodriguez.utils.SeparatorUtils.s + ":*?\"<>|]", "_");
                nombre[1] = nombre[1].replaceAll("[/" + main.java.org.ignaciorodriguez.utils.SeparatorUtils.s + "" + main.java.org.ignaciorodriguez.utils.SeparatorUtils.s + ":*?\"<>|]", "_");
            }
            if (nombre[1].isBlank()) {
                nombreBase = "" + main.java.org.ignaciorodriguez.utils.SeparatorUtils.s + "Inf. " + id + " " + prefijoNombre + " " + nombre[0];
            } else {
                nombreBase = "" + main.java.org.ignaciorodriguez.utils.SeparatorUtils.s + "Inf. " + id + " " + prefijoNombre + " " + nombre[1];
            }
            String nombrePdfSinEspaciosInicio = nombreBase.replaceAll("^" + main.java.org.ignaciorodriguez.utils.SeparatorUtils.s + "s*", "");                                                       //principio, final y se sacan las comillas
            String nombrePdfSinEspacios = nombrePdfSinEspaciosInicio.replaceAll("" + main.java.org.ignaciorodriguez.utils.SeparatorUtils.s + "s*$", "");
            ...
            ImageIcon icon = new ImageIcon("src" + main.java.org.ignaciorodriguez.utils.SeparatorUtils.s + "vista" + main.java.org.ignaciorodriguez.utils.SeparatorUtils.s + "icono.png");
    ...
    public void generarReporteFQCompleto(String archivoJasper, int id, String prefijoNombre,
        ...
        try {
            ...
            if (nombre[0].contains("/") || nombre[0].contains("" + main.java.org.ignaciorodriguez.utils.SeparatorUtils.s + "") || nombre[0].contains(":") || nombre[0].contains("*") || nombre[0].contains("?") || nombre[0].contains("\"") || nombre[0].contains("<") || nombre[0].contains(">") || nombre[1].contains("/") || nombre[1].contains("" + main.java.org.ignaciorodriguez.utils.SeparatorUtils.s + "") || nombre[1].contains(":") || nombre[1].contains("*") || nombre[1].contains("?") || nombre[1].contains("\"") || nombre[1].contains("<") || nombre[1].contains(">")) {
                nombre[0] = nombre[0].replaceAll("[/" + main.java.org.ignaciorodriguez.utils.SeparatorUtils.s + "" + main.java.org.ignaciorodriguez.utils.SeparatorUtils.s + ":*?\"<>|]", "_");
                nombre[1] = nombre[1].replaceAll("[/" + main.java.org.ignaciorodriguez.utils.SeparatorUtils.s + "" + main.java.org.ignaciorodriguez.utils.SeparatorUtils.s + ":*?\"<>|]", "_");
            }

            String nombreBase = main.java.org.ignaciorodriguez.utils.SeparatorUtils.s + "Inf. " + id + nombrePdfTipo +
                    (nombre[1] == null || nombre[1].isBlank() ? nombre[0] : nombre[1]);
            String nombreSinEspaciosIinicio = nombreBase.replaceAll("^" + main.java.org.ignaciorodriguez.utils.SeparatorUtils.s + "s*", "");
            String nombreSinEspacios = nombreSinEspaciosIinicio.replaceAll("" + main.java.org.ignaciorodriguez.utils.SeparatorUtils.s + "s*$", "");
            ...
            vistaReporte.setDefaultCloseOperation(JasperViewer.DO_NOTHING_ON_CLOSE);
            vistaReporte.setExtendedState(Frame.MAXIMIZED_BOTH);
            vistaReporte.setIconImage(new ImageIcon("src" + main.java.org.ignaciorodriguez.utils.SeparatorUtils.s +
                    "vista" + main.java.org.ignaciorodriguez.utils.SeparatorUtils.s +
                    "icono.png").getImage());
            vistaReporte.setVisible(true);
    ...
    public void generarReporteEnProceso(int id, String texto) {
        try {
            ...
            String nombreBase = main.java.org.ignaciorodriguez.utils.SeparatorUtils.s + "Informe en proceso " + id;
            String nombreSinEspaciosInicio = nombreBase.replaceAll("^" + main.java.org.ignaciorodriguez.utils.SeparatorUtils.s + "s*", "");
            String nombreSinEspacios = nombreSinEspaciosInicio.replaceAll("" + main.java.org.ignaciorodriguez.utils.SeparatorUtils.s + "s*$", "");
            String nombrePdf = nombreSinEspacios.replace("\"", "") + ".pdf";
